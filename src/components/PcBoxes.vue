<template>
    <div class="pc-boxes bg-pokemon-dark p-4 text-white text-center max-w-full max-h-full overflow-hidden">
      <h2 class="text-2xl font-semibold">PC</h2>
  
      <!-- Display Pokémon icons in a 5x6 grid -->
      <div class="grid grid-cols-6 gap-2 bg-pokemon-dark-shaded p-5 mb-4">
        <div
  ...
  .pc-boxes {
    ...
    align-items: center;
    justify-content: flex-start; /* Align content to the start to move it to the top */
    ...
    flex-grow: 2; /* Adjust flex-grow as needed to fill the available space */
  }
